const createProduct = (data) => {
    ...
    <div class="product-card">
            ...
            <div class="product-info">
                ...
                <p class="product-short-description">${data.shortDes}</p>
                <span class="discount-price">${data.sellPrice} bdt</span>
                <span class="actual-price">${data.actualPrice} bdt</span>
            </div>
        </div>`;
}
    ...
    fetch('/delete-product', {
        ...
        .then(data => {
            if (data == 'success') {
                ...
                showAlert('something went wrong when deleting the product, please try again');
            }
        })
}